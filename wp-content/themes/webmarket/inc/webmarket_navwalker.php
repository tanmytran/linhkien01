<?php
/**
 * Walker for the menu, has to change a little the default wp_bootstrap_navwalker class to enable links (without clicks)
 *
 * @package Webmarket
 */
require_once dirname( __FILE__ ) . '/../bower_components/wp-bootstrap-navwalker/wp_bootstrap_navwalker.php';

class Webmarket_Navwalker extends wp_bootstrap_navwalker {
	/**
	 * @see Walker::start_el()
	 * @since 3.0.0
	 *
